        ...
        <div class="lockscreen-container">
            ...
            <div class="lockscreen-box animated fadeInDown">
                ...
                <div class="lsb-access">
                    <div class="lsb-box">
                        ...
                        <div class="user animated fadeIn">
                            <img src="<?php echo admin_asset_url(); ?>assets/images/users/user2.jpg" alt="John Doe"/>
                ...
                <div class="lsb-form animated fadeInDown">
                    <form action="<?php echo base_url(); ?>index.php/administrator" method="post" class="form-horizontal">
